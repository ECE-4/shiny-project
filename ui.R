      ...
      tabPanel(
        ...
        sidebarLayout(
          ...
          mainPanel(
            ...
            br(),
            p("a) Make sure that you have",strong(" shiny installed")," on your computer, if not install it by running :", code("install::packages('shiny')")),
            p("b) In the console, run the following line :", code("runApp()")),
            p("c) Your app should be running locally ! :)"),
            br(),
            h3("2. Use the App"),
